...
- EDCM keeps `characters -> words -> definitions -> recursive gonol relations` load-bearing while preserving identity, occurrence, order, multiplicity, relation identity, source, and provenance; `edcm.gonol` is the implemented candidate constructor;

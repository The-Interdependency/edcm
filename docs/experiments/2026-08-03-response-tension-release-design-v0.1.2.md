...
## Frozen next-experiment packet v0.1.2
...
| Schema | `edcm.response-tension-release-experiment/0.1.2` |
| Candidate | `edcm.response-tension-release/0.1.0` |
| Canon selection | `null` |
| Supersedes | Immutable v0.1.1 packet SHA-256 `29bb95d7ef51836c3b16d1979d1d258eea5930fb12c47b8c376d7cc62a127465` |

This complete v0.1.2 packet freezes the same single new experiment design and
supersedes v0.1.1 only to bind the final repaired predecessor identity and two
additional source/runtime controls. It does not modify the immutable v0.1.0 or
v0.1.1 bytes, authorize execution, alter EDCM equations, reopen prior evidence,
activate production, or select a canonical measurement. Neither earlier packet
was executed; no candidate input, human label, partition membership, per-event
score, or sealed outcome was viewed between packet versions.

This v0.1.2 packet is immutable. Named people, keys, encrypted-bundle digests,

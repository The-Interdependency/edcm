...
## Frozen next-experiment packet v0.1.4
...
| Supersedes | Immutable v0.1.3 packet SHA-256 `3e3167da26d0d89b2acfc54b6f98e08220e0858c4e450e819efd366a4d6527e9` |
| Current-packet index | `docs/experiments/README.md` |

This complete v0.1.4 packet freezes the same single new experiment design and
supersedes v0.1.3 only to bind the current repaired predecessor identity and the
transitive score-affecting runtime provenance repair. It does not modify any
immutable earlier packet, authorize execution, alter EDCM equations, reopen
...
This v0.1.4 packet is immutable. Named people, keys, encrypted-bundle digests,
